...
$("#loginform .arrow--button__nextBtn").click(function (e) {
    e.preventDefault();
...
//$(document).ready(function () {
  ...
  $("#gen_loginotpform #step2 .arrow--button__nextBtn").click(function () {
	...
	var curStep = $(this).closest(".stepper--content"),
		...
		isValid = true;
		$(".custom--input").removeClass("is-invalid");
		$("#gen_loginotpform #step2 .invalid-message").remove();
		console.log(curStepBtn);
		if(curStepBtn == "step2") {
			curInputs = curStep.find("input[required='required'],select");
	...
	$("#loginotpform #step3 .arrow--button__nextBtn").click(function () {
...
$("#forgot_pass_form #step1 .arrow--button__nextBtn").click(function () {
		...
		if(inputId == 'c_password'){
			...
			if(cpass != '' && cpass != undefined && cpass != 'undefined'){
				if(pass != '' && pass != undefined && pass != 'undefined'){
					...
					if(cpass !== pass){
						var errorMsg1 = 'Please enter same as new password.';
					}
				}else{
